...
public class BlogResult {
    ...
    public static BlogResult successfulBlogResult(String msg, Integer total, Integer page, Integer totalPage, List<Blog> data) {
        return new BlogResult("ok", msg, total, page, totalPage, data);
    }

    public static BlogResult successfulBlogIdResult(String msg, List<Blog> data) {
